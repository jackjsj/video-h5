...
import {
  ...
  POST_TOKEN,
  POST_TOKEN_FORM
} from "./ajaxRequestType";
import { BASE_URL } from "../common/config";

// 获取首页数据
export const getIndexInfo = () =>
  ajax(`${BASE_URL}/openapi/indexInfo`, {}, POST_JSON);

// 导航模块
// 获取标签类型
export const getTagType = () =>
  ajax(`${BASE_URL}/openapi/selectTagType`, {}, POST_JSON);
...
// 获取周排行
export const findWeeklyPays = () =>
  ajax(`${BASE_URL}/openapi/videoPay/findWeeklyPays`, {}, GET);
// 获取月排行
export const findMonthlyPays = () =>
  ajax(`${BASE_URL}/openapi/videoPay/findMonthlyPays`, {}, GET);
...
export const getStarList = params =>
  ajax(`${BASE_URL}/ying/getStarPage`, params, POST_TOKEN);

// 获取明星信息
export const getStarInfo = id =>
  ajax(`${BASE_URL}/openapi/getStarInfo`, { id }, POST_TOKEN);

// 收藏明星列表
export const saveMemberCollect = starId =>
  ajax(
    `${BASE_URL}/ying/memberStar/saveMemberCollect`,
    { starId },
    POST_TOKEN_FORM
  );
// 取消收藏明星
...
export const getCaricatureInfo = caricatureId =>
  ajax(
    `${BASE_URL}/ying/caricature/getCaricatureDetail`,
    { caricatureId },
    POST_TOKEN
  );
...
export const getCaricatureChapterInfo = caricatureId =>
  ajax(
    `${BASE_URL}/openapi/caricatureChapter/getListByCaricatureId`,
    { caricatureId },
    POST_JSON
  );
...
export const getChapterPictureList = chapterId =>
  ajax(
    `${BASE_URL}/ying/caricatureChapter/getChapterDetail`,
    { chapterId },
    POST_TOKEN
  );
...
export const addCaricatureCollect = caricatureId =>
  ajax(
    `${BASE_URL}/ying/apiCaricatureBookcase/save`,
    { caricatureId },
    POST_TOKEN
  );
// 删除漫画收藏
export const delCaricatureCollect = caricatureId =>
  ajax(
    `${BASE_URL}/ying/apiCaricatureBookcase/del`,
    [caricatureId],
    POST_TOKEN
  );
...
// 获取电影搜索热门标签
export const getMovieHotLabel = () =>
  ajax(`${BASE_URL}/openapi/searchSearchName`, {}, POST_JSON);

//获取影片信息
export const getVideoDetail = params =>
  ajax(`${BASE_URL}/ying/getVideoDetail`, params, POST_TOKEN);

// 用户登录
export const login = params =>
  ajax(`${BASE_URL}/openapi/login`, params, POST_JSON);
...
//添加用户影片收藏
export const setCareHistory = params =>
  ajax(`${BASE_URL}/ying/setCareHistory`, params, POST_TOKEN);
...
export const getCaricatureBookcaseList = params =>
  ajax(
    `${BASE_URL}/ying/apiCaricatureBookcase/getCaricatureBookcaseList`,
    params,
    POST_TOKEN
  );
...
export const addIntegral = integralId =>
  ajax(
    `${BASE_URL}/ying/payOpenSetting/addIntegral`,
    { integralId },
    POST_TOKEN_FORM
  );
...
export const exchangeVip = integralVipId =>
  ajax(
    `${BASE_URL}/ying/integralVip/exchange`,
    { integralVipId },
    POST_TOKEN_FORM
  );
...
export const getMemberInfo = params =>
  ajax(`${BASE_URL}/ying/getMemberInfo`, params, POST_TOKEN);
...
export const getSmsCode = params =>
  ajax(`${BASE_URL}/openapi/getSmsCode`, params, POST_JSON);

//手机号注册
export const telRegedit = params =>
  ajax(`${BASE_URL}/openapi/regedit`, params, POST_JSON);

//修改密码
export const loseTel = params =>
  ajax(`${BASE_URL}/openapi/loseTel`, params, POST_JSON);

//影片点赞
export const setCareTimess = params =>
  ajax(`${BASE_URL}/ying/setCareTimes`, params, POST_TOKEN);

// 添加积分
export const checkInAddIntegral = integralId =>
  ajax(
    `${BASE_URL}/ying/integralClassify/addIntegral`,
    { integralId },
    POST_TOKEN_FORM
  );
...
export const getPayType = () =>
  ajax(`${BASE_URL}/openapi/getPayType`, {}, POST_JSON);

//获取卡密类型
export const getVipList = () =>
  ajax(`${BASE_URL}/ying/getVipList`, {}, POST_JSON);
...
// 获取交流群接口
export const getGcGroup = () =>
  ajax(`${BASE_URL}/openapi/acGroup/getAcGroup`, {}, POST_JSON);
...
// 根据广告类型获取广告
export const getBannerByCid = cId =>
  ajax(`${BASE_URL}/openapi/findBanner`, { cId }, POST_FORM);
